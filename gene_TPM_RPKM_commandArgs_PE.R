...
# Usage:
# Rscript gene_TPM_RPKM_commandArgs_PE.R ../../WT_RNAseq_meiocyte_Rep1_SRR4204534_STAR_mapped_both_sort.bam WT_RNAseq_meiocyte_Rep1_SRR4204534

source("/projects/ajt200/Rfunctions/RPKMandTPMcalc_TEST.R")
library(genomation)
library(ShortRead)
library(parallel)
...
# Run RPKMandTPMcalcPE() on the library
RPKMandTPMcalcPE(bamFile = bamFile,
                 libName = libName,
                 features = genesGR,
                 featureName = "genes",
                 outDir = outDir)
