...
# Usage:
# Rscript gene_TPM_RPKM_commandArgs_SE.R ../../WT_RNAseq_meiocyte_Rep1_SRR4204534_STAR_mapped_both_sort.bam WT_RNAseq_meiocyte_Rep1_SRR4204534
...
# Run RPKMandTPMcalcSE() on the library
RPKMandTPMcalcSE(bamFile = bamFile,
                 libName = libName,
                 features = genesGR,
                 featureName = "genes",
                 outDir = outDir)
